...
def add_slide_title(spTree, title_text):
    ...
    color_el = doc.createElement("a:solidFill")
    srgb_el = doc.createElement("a:srgbClr")
    srgb_el.setAttribute("val", "800000")
    color_el.appendChild(srgb_el)
...
def add_title_slide_content(spTree, title, subtitle):
    ...
    srgb_title.setAttribute("val", "800000")
    ...
    srgb_sub.setAttribute("val", "444444")
...
def add_text_column(spTree, x, y, cx, cy, bullets, col_id):
    ...
    for bullet in bullets:
        ...
        if m:
            ...
            color_el = doc.createElement("a:solidFill")
            srgb_el = doc.createElement("a:srgbClr")
            srgb_el.setAttribute("val", "222222")
            color_el.appendChild(srgb_el)
            ...
            if reg_part:
                ...
                color_el = doc.createElement("a:solidFill")
                srgb_el = doc.createElement("a:srgbClr")
                srgb_el.setAttribute("val", "333333")
                color_el.appendChild(srgb_el)
...
slides_content = {
    ...
    2: {
        ...
        "columns": [
            {
                "x": 1000000, "y": 3000000, "cx": 7915400, "cy": 6500000,
                "bullets": [
            ...
            {
                "x": 9372600, "y": 3000000, "cx": 7915400, "cy": 6500000,
                "bullets": [
    ...
    6: {
        ...
        "columns": [
            {
                "x": 1000000, "y": 3000000, "cx": 4000000, "cy": 6500000,
                "bullets": [
            ...
            {
                "x": 5457200, "y": 3000000, "cx": 4000000, "cy": 6500000,
                "bullets": [
        ...
        "charts": [
            {
                "x": 9914400, "y": 3000000, "cx": 7373600, "cy": 3000000,
                "name": "q13_order_profile_comparison.png"
            },
            {
                "x": 9914400, "y": 6500000, "cx": 7373600, "cy": 3000000,
